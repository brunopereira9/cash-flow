...
{
    public static WebApplicationBuilder AddCoreTelemetry(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddOpenTelemetry()
            .ConfigureResource(resource => resource
                .AddService(
                    builder.Configuration["OTEL_SERVICE_NAME"] ?? "cash-flow-core-api",
            ...
            .WithTracing(tracing => tracing
                ...
                .AddSource("CashFlow.Core.Messaging")
                .AddOtlpExporter())
            .WithMetrics(metrics => metrics
                .AddAspNetCoreInstrumentation()
                .AddRuntimeInstrumentation()
                .AddMeter("CashFlow.Core")
                .AddOtlpExporter());
